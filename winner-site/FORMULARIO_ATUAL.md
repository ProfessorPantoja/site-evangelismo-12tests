...
- `⏰ Horário: 09h às 17h (manhã e tarde)`
- `📍 Local: Igreja ADMPF`
- `Av. Pastor Martin Luther King Jr., 3.275`
...
4. `Como você ficou sabendo deste evento? (opcional)`
Tipo: caixas de selecao
Opcoes:
- `Redes sociais (Instagram/Facebook etc.)`
- `Convite pessoal de um amigo/membro`
- `Anúncio na igreja`
- `Site / mensagem / lista`
- `Outro`
...
1. `Deseja receber informações futuras sobre eventos e atividades da igreja? *`
Tipo: multipla escolha
Opcoes:
- `Sim, pode me avisar`
- `Não, obrigado(a)`
...
2. `💳 Pagamento (Pix)`
Tipo: bloco informativo
Conteudo:
- `✅ Faça o Pix de R$ 20,00 e anexe o comprovante no final.`
- `🔑 Chave Pix: 325213360001-96`
- `ou use o QRCODE abaixo.`
- `📲 Em caso de dificuldade, fale com: (21) 97733-6783`

3. `QR CODE DO PIX DA IGREJA ADMPF para seu conforto use o qrcode.`
Tipo: bloco informativo com imagem

4. `Anexar Comprovante de 20 reais.`
